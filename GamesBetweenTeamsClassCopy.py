...
class GamesBetweenTeamsClassCopy:
    team1_id = -1
    team2_id = -1
    team1 = ''
    team2 = ''
    ...
    def setStats(self):
        ...
        for game in self.games:
            ...
            if (game.get('away').get('team').get('id') == self.team1_id):
                ...
                '''self.runs[0].append(away_batting.get('runs'))
                self.doubles[0].append(away_batting.get('doubles'))
                self.triples[0].append(away_batting.get('triples'))
                self.homeRuns[0].append(away_batting.get('homeRuns'))
                self.strikeOuts[0].append(away_batting.get('strikeOuts'))
                self.baseOnBalls[0].append(away_batting.get('baseOnBalls'))
                self.hits[0].append(away_batting.get('hits'))
                self.avg[0].append(away_batting.get('avg'))
                self.atBats[0].append(away_batting.get('atBats'))
                self.obp[0].append(away_batting.get('obp'))
                self.slg[0].append(away_batting.get('slg'))
                self.stolenBases[0].append(away_batting.get('stolenBases'))
                self.leftOnBase[0].append(away_batting.get('leftOnBase'))
                self.earnedRuns[0].append(away_pitching.get('earnedRuns'))'''
                self.ops[0].append(away_batting.get('ops'))         #ops statistics
                self.era[0].append(away_pitching.get('era'))        #era statistics
                '''
                self.runs[1].append(home_batting.get('runs'))
                self.doubles[1].append(home_batting.get('doubles'))
                self.triples[1].append(home_batting.get('triples'))
                self.homeRuns[1].append(home_batting.get('homeRuns'))
                self.strikeOuts[1].append(home_batting.get('strikeOuts'))
                self.baseOnBalls[1].append(home_batting.get('baseOnBalls'))
                self.hits[1].append(home_batting.get('hits'))
                self.avg[1].append(home_batting.get('avg'))
                self.atBats[1].append(home_batting.get('atBats'))
                self.obp[1].append(home_batting.get('obp'))
                self.slg[1].append(home_batting.get('slg'))
                self.stolenBases[1].append(home_batting.get('stolenBases'))
                self.leftOnBase[1].append(home_batting.get('leftOnBase'))
                self.earnedRuns[1].append(home_pitching.get('earnedRuns'))
                '''
                self.ops[1].append(home_batting.get('ops'))         #ops statistics
                self.era[1].append(home_pitching.get('era'))        #era statistics

            else:
                '''
                self.runs[1].append(away_batting.get('runs'))
                self.doubles[1].append(away_batting.get('doubles'))
                self.triples[1].append(away_batting.get('triples'))
                self.homeRuns[1].append(away_batting.get('homeRuns'))
                self.strikeOuts[1].append(away_batting.get('strikeOuts'))
                self.baseOnBalls[1].append(away_batting.get('baseOnBalls'))
                self.hits[1].append(away_batting.get('hits'))
                self.avg[1].append(away_batting.get('avg'))
                self.atBats[1].append(away_batting.get('atBats'))
                self.obp[1].append(away_batting.get('obp'))
                self.slg[1].append(away_batting.get('slg'))
                self.stolenBases[1].append(away_batting.get('stolenBases'))
                self.leftOnBase[1].append(away_batting.get('leftOnBase'))
                self.earnedRuns[1].append(away_pitching.get('earnedRuns'))'''
                self.ops[1].append(away_batting.get('ops'))         #ops statistics
                self.era[1].append(away_pitching.get('era'))        #era statistics

                '''
                self.runs[0].append(home_batting.get('runs'))
                self.doubles[0].append(home_batting.get('doubles'))
                self.triples[0].append(home_batting.get('triples'))
                self.homeRuns[0].append(home_batting.get('homeRuns'))
                self.strikeOuts[0].append(home_batting.get('strikeOuts'))
                self.baseOnBalls[0].append(home_batting.get('baseOnBalls'))
                self.hits[0].append(home_batting.get('hits'))
                self.avg[0].append(home_batting.get('avg'))
                self.atBats[0].append(home_batting.get('atBats'))
                self.obp[0].append(home_batting.get('obp'))
                self.slg[0].append(home_batting.get('slg'))
                self.stolenBases[0].append(home_batting.get('stolenBases'))
                self.leftOnBase[0].append(home_batting.get('leftOnBase'))
                self.earnedRuns[0].append(home_pitching.get('earnedRuns'))'''
                self.ops[0].append(home_batting.get('ops'))     #ops statistics
                self.era[0].append(home_pitching.get('era'))    #era statistics
...
def getGamesBetweenTeams(team1_id, team2_id, start_date='input start mm/dd/YY', end_date='input end mm/dd/YY'):
    return GamesBetweenTeamsClassCopy(team1_id=team1_id, team2_id=team2_id, start_date=start_date, end_date=end_date)
...
test = GamesBetweenTeamsClassCopy(143, 120, '01/01/2015', '12/31/2019')
